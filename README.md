...
- 🎯 Entry points to execute your program using `python -m <euvalues>` or `$ euvalues` with basic CLI argument parsing.
...
```py
from euvalues import BaseClass
from euvalues import base_function
